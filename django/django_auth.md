...
{% endblock content %}
```
* mainapp/templates/includes/main_menu.html добаляем необходимые ссылки
```html
{% load static %}
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="ddProfile">
            <a class="dropdown-item"
              href="{% url 'authapp:profile_edit' %}">Редактировать
              профиль</a>
            <a class="dropdown-item" href="#">Мои курсы</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#">Модерация</a>
            {% if user.is_superuser %}
            <a class="dropdown-item" href="#">Административный
              раздел</a>
            {% endif %}
            <div class="dropdown-divider"></div>
